...
Finalmente, los datos extraídos contienen los siguientes campos:
     ...
     6. **ATTACK**:
     7. **TARGET_CLASS**:
     8. **COUNTRY**: País receptor del ataque cibernético.
     9. **LINK**: 
     10.**AUTHOR_REPORT**: Nombre del autor que ha publicado el report en el Timeline. No aplica para Master Table 2018 y 2017.
     11.**DATE_REPORT**: Fecha de publicación del report en el Timeline. No aplica para Master Table 2018 y 2017.
     12.**VIEWS**: Número de visualizaciones del report en el Timeline. No aplica para Master Table 2018 y 2017.
