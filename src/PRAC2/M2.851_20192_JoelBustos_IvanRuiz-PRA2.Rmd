...
boxplot(casosConAutor)
boxplot(casosAnonimos)
boxplot(NumeroAtaques)
boxplot(casosMultiataque)
boxplot(casosCyberCrime)
boxplot(casosCyberEspionage)
boxplot(casosCyberWarfae)
boxplot(casosHacktivism)
boxplot(casosTipoAtaqueDesconocido)
...
boxplot(attacks_agg1$casosConAutor, col=attacks_agg1$Code_target_class)
boxplot(attacks_agg1$casosAnonimos, col=attacks_agg1$Code_target_class)
boxplot(attacks_agg1$NumeroAtaques, col=attacks_agg1$Code_target_class)

# Representación de los histogramas para las variables numéricas

par(mfrow=c(1,3)) 

hist(attacks_agg1$casosConAutor, col=attacks_agg1$Code_target_class, breaks = 50)
hist(attacks_agg1$casosAnonimos, col=attacks_agg1$Code_target_class, breaks = 50)
hist(attacks_agg1$NumeroAtaques, col=attacks_agg1$Code_target_class, breaks = 50)
...
plot(casosConAutor, col=attacks_Input$Code_target_class)
plot(casosAnonimos, col=attacks_Input$Code_target_class)
plot(NumeroAtaques, col=attacks_Input$Code_target_class)
plot(casosMultiataque, col=attacks_Input$Code_target_class)
plot(casosCyberCrime, col=attacks_Input$Code_target_class)
plot(casosCyberEspionage, col=attacks_Input$Code_target_class)
plot(casosCyberWarfae, col=attacks_Input$Code_target_class)
plot(casosHacktivism, col=attacks_Input$Code_target_class)
plot(casosTipoAtaqueDesconocido, col=attacks_Input$Code_target_class)
...
plot(casosConAutor[exclEnt], col=attacks_Input$Code_target_class[exclEnt])
plot(casosAnonimos[exclEnt], col=attacks_Input$Code_target_class[exclEnt])
plot(NumeroAtaques[exclEnt], col=attacks_Input$Code_target_class[exclEnt])
plot(casosMultiataque[exclEnt], col=attacks_Input$Code_target_class[exclEnt])
plot(casosCyberCrime[exclEnt], col=attacks_Input$Code_target_class[exclEnt])
plot(casosCyberEspionage[exclEnt], col=attacks_Input$Code_target_class[exclEnt])
plot(casosCyberWarfae[exclEnt], col=attacks_Input$Code_target_class[exclEnt])
plot(casosHacktivism[exclEnt], col=attacks_Input$Code_target_class[exclEnt])
plot(casosTipoAtaqueDesconocido[exclEnt], col=attacks_Input$Code_target_class[exclEnt])
